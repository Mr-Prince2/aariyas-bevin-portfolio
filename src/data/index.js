...
export const projects = [
  {
    ...
    title: 'RoadAI Sentinel',
    desc: 'AI-powered road damage detection and maintenance scheduling. Multi-model pipeline combining YOLOv9, ResNet-50, and depth estimation for real-time road condition analysis deployed on edge devices.',
  ...
  },
  {
    ...
    desc: 'Natural language queries, anomaly detection, and automated backup system for intelligent database management.',
