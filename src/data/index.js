...
export const projects = [
  ...
  },
  {
    ...
    demo: 'https://kuber.aariyasbevin.me',
    featured: false,
  ...
  },
  {
    ...
    github: 'https://github.com/Mr-Prince2/Vazhi.git',
    demo: '#',
    featured: false,
  ...
  },
  {
    ...
    title: 'Duck-Hunt',
    desc: 'A high-fidelity, 60+ FPS browser recreation of Nintendo\'s iconic 1984 NES classic. Features switchable CRT scanline emulation, lightgun recoil screen shake, muzzle sparks, dynamic audio pooling, and mobile touch support.',
    stack: ['React', 'Vite', 'Web Audio API', 'CSS3', 'localStorage'],
    github: 'https://github.com/Mr-Prince2/duck-hunt.git',
    demo: 'https://duck-hunt.aariyasbevin.me',
    featured: false,
  ...
  },
  {
    id: 5,
    icon: '打',
    category: 'Cyberpunk Typing Game',
    title: 'Typor',
    desc: 'TYPE // OVERDRIVE is an intense cyberpunk typing engine and multiplayer speed competition featuring real-time P2P peer-to-peer matchmaking via PeerJS, dynamic WPM/accuracy telemetry, and retro-futuristic soundscapes.',
    stack: ['React', 'Vite', 'PeerJS', 'Web Audio API', 'CSS3'],
    github: 'https://github.com/Mr-Prince2/typor.git',
    demo: 'https://typor.aariyasbevin.me',
    featured: false,
  ...
  //   desc: 'Project 6 description goes here. This is a placeholder description for the sixth project, which will be updated with real content later.',
